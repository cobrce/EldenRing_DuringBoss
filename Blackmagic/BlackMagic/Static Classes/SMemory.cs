...
namespace Magic
{
	...
	public static class SMemory
	{
		...
		public static int ReadRawMemory(IntPtr hProcess, long dwAddress, IntPtr lpBuffer, int nSize)
		{
			int lpBytesRead = 0;
		...
		public static byte[] ReadBytes(IntPtr hProcess, long dwAddress, int nSize)
		{
		...
		public static byte ReadByte(IntPtr hProcess, long dwAddress)
		{
		...
		/// <param name="bReverse">Determines whether bytes will be reversed before returning or not (big-endian or little-endian)</param>
		/// <returns>Returns memory read from external process.</returns>
		public static int ReadInt(IntPtr hProcess, long dwAddress, bool bReverse)
		{
		...
		/// <param name="bReverse">Determines whether bytes will be reversed before returning or not (big-endian or little-endian)</param>
		/// <returns>Returns memory read from external process.</returns>
		public static Int64 ReadInt64(IntPtr hProcess, long dwAddress, bool bReverse)
		{
